...
type BankServiceClient interface {
	...
	FetchExchangeRateRequest(ctx context.Context, in *ExchangeRateRequest, opts ...grpc.CallOption) (grpc.ServerStreamingClient[ExchangeRateResponse], error)
	SummarizeTransaction(ctx context.Context, opts ...grpc.CallOption) (grpc.ClientStreamingClient[Transaction, TransactionSummary], error)
}
...
func (c *bankServiceClient) FetchExchangeRateRequest(ctx context.Context, in *ExchangeRateRequest, opts ...grpc.CallOption) (grpc.ServerStreamingClient[ExchangeRateResponse], error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
...
type BankService_FetchExchangeRateRequestClient = grpc.ServerStreamingClient[ExchangeRateResponse]

func (c *bankServiceClient) SummarizeTransaction(ctx context.Context, opts ...grpc.CallOption) (grpc.ClientStreamingClient[Transaction, TransactionSummary], error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
...
// This type alias is provided for backwards compatibility with existing code that references the prior non-generic stream type by name.
type BankService_SummarizeTransactionClient = grpc.ClientStreamingClient[Transaction, TransactionSummary]
...
type BankServiceServer interface {
	...
	FetchExchangeRateRequest(*ExchangeRateRequest, grpc.ServerStreamingServer[ExchangeRateResponse]) error
	SummarizeTransaction(grpc.ClientStreamingServer[Transaction, TransactionSummary]) error
...
func (UnimplementedBankServiceServer) FetchExchangeRateRequest(*ExchangeRateRequest, grpc.ServerStreamingServer[ExchangeRateResponse]) error {
	return status.Errorf(codes.Unimplemented, "method FetchExchangeRateRequest not implemented")
}
func (UnimplementedBankServiceServer) SummarizeTransaction(grpc.ClientStreamingServer[Transaction, TransactionSummary]) error {
...
func _BankService_FetchExchangeRateRequest_Handler(srv interface{}, stream grpc.ServerStream) error {
	...
	return srv.(BankServiceServer).FetchExchangeRateRequest(m, &grpc.GenericServerStream[ExchangeRateRequest, ExchangeRateResponse]{ServerStream: stream})
}

// This type alias is provided for backwards compatibility with existing code that references the prior non-generic stream type by name.
type BankService_FetchExchangeRateRequestServer = grpc.ServerStreamingServer[ExchangeRateResponse]

func _BankService_SummarizeTransaction_Handler(srv interface{}, stream grpc.ServerStream) error {
	return srv.(BankServiceServer).SummarizeTransaction(&grpc.GenericServerStream[Transaction, TransactionSummary]{ServerStream: stream})
}

// This type alias is provided for backwards compatibility with existing code that references the prior non-generic stream type by name.
type BankService_SummarizeTransactionServer = grpc.ClientStreamingServer[Transaction, TransactionSummary]
