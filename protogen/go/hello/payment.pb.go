...
func (x *PaymentRequest) GetCart() *Cart {
	if x != nil {
		return x.Cart
	}
	return nil
...
var file_proto_payment_payment_proto_rawDesc = []byte{
	...
	0x63, 0x6f, 0x6d, 0x2f, 0x4c, 0x65, 0x65, 0x6d, 0x61, 0x63, 0x69, 0x6e, 0x74, 0x79, 0x72, 0x65,
...
func file_proto_payment_payment_proto_init() {
	...
	file_proto_transaction_cart_proto_init()
	if !protoimpl.UnsafeEnabled {
